...
public class Tags {
	...
	private Map<Integer,ArrayList<Tag>> tags = new HashMap<Integer, ArrayList<Tag>>();

	public void add (Tag t) {
		if (tags.get(t.id) == null)
			tags.put(t.id, new ArrayList<Tag>());
		tags.get(t.id).add(t);
	}
	...
	public Map<Integer,ArrayList<Tag>> getTags () {
		return tags;
	}
